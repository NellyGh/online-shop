		...
		<footer className="footer">
			<div className="footer__container _container">
				...
				<div className="footer__bottom">
					<p>Создание и продвижение сайта - студия <a href="https://webstructure.ru">«ВЕБСТРУКТУР»</a></p>
					<p>Сайт носит информационный характер и ни при каких условиях не является публичной офертой,
						определяемой положениями статьи 437(2) Гражданского кодекса Российской Федерации. Условия и
						стоимость предоставления услуг необходимо уточнять у менеджера.</p>
